...
def instantiate_models(strategies, n_users, n_items, items_items_distances, items_genres_matrix, rating_predicted, device,
                       clip_min, clip_max, evaluate, dataset_name, jaccard_distance):
    models_dict = {}
    ...
    if "k_means_with_relevance" in strategies or "k_means_without_relevance" in strategies:
        ...
        interacted_distance = InteractedDistance(n_users, n_items, rating_predicted, items_items_distances, device, clip_min,
                                                 clip_max, evaluate)
...
def save_ranking_2file(dataset_name, k_param, regime, ranking, strategy):
    ...
    filename = folderpath + dataset_name + '_'+ str(k_param) + '_'+ regime + '_'+ strategy + '.txt'
