...
def get_recommendation(datset_name, filter_method, k_param, ratings, items_items_distances, mapping_range, regime, top_num):
    ...
    for i, seq_list in enumerate(result_list):
        ...
        save_ranking_2file_old(datset_name, k_param, regime, ranking= seq_list)
...
def main(dataset_name):
    ...
    filter_method_list = ['MSD', 'Dist', 'Dist_Prob', 'Matching','Relevance','NoFilter']
    filter_method_list = ['MSD', 'Dist', 'Dist_Prob', 'Matching','Relevance']
    # filter_method_list = [ 'MSD', 'NoFilter']

    strategy = 'CIKM_bke_filter_method_largek'
...
if __name__ == '__main__':
    ...
    # datasets = ["coat"]
    # datasets = [ "netflix","movielens", "KuaiRec", "yahoo"]
