...
def get_recommendation(datset_name, k_param, ratings, distance_matrix, regime, top_num, strategy):
    ...
    return np.average(expectation_arr), np.std(expectation_arr), recommendation_list
...
def main(dataset_name):
    ...
    for regime in regimes:
        ...
        for k_param in [3]:
            ...
            exp_avg, exp_std, recomendation_list = get_recommendation(dataset_name, k_param, ratings, distance_matrix, regime, top_num, strategy)

            print('expectation for strategy ', strategy, " with k = ", k_param,
                  " is ", exp_avg, exp_std, ' for dataset ',
                  dataset_name, ' for regime ', regime, 'spend time ', time.time()-start)
            ...
            save_ranking_2file(ranking_folder, dataset_name, k_param, regime, recomendation_list, strategy)
