...
def get_recommendation(datset_name, k_param, ratings, items_items_distances, regime, strategy):
    ...
    for i, seq_list in enumerate(result_list):
        recommendation_liat.extend(seq_list)
        chunk = chunk_range[i]
    ...
    return np.average(expectation_arr), np.std(expectation_arr), recommendation_liat
...
def main(dataset_name):
    ...
    for regime in regimes:
        ...
        exp_avg, exp_std, recommendation_list = get_recommendation(dataset_name, k_param, ratings, distance_matrix, regime, strategy)
