...
def get_recommendation(dataset_name, qid, regime, lambda_factor, ratings, items_items_distances, mapping_range):
    ...
    best_sequence = search_best_ranking(  similarity_matrix, items_continue_p, lambda_factor)
...
def search_best_ranking( similarity, rating, lambda_factor):

    relevance = copy.deepcopy(rating)
    num_items = len(rating)
