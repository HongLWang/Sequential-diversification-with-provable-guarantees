...
def Save_ExpMetric(dataset_name, method_list, regime_list):
    ...
    rating_interploted_fp = f'../ProcessedData/rating_{dataset_name}.npy'
    ...
    for method in method_list:
        for regime in regime_list:
            ...
            ranking_path = obtain_filepath(dataset_name, method, regime)
...
if __name__ == '__main__':
    ...
    method_list = ['EXPLORE','Random', 'DUM', 'MSD', 'MMR', 'dpp', 'B2I', 'filter3','filter4']
